...
## 8. การจัดทำโครงสร้างพื้นฐานระบบ (DevOps Architecture)

โปรเจกต์นี้ได้รับการจัดทำโครงสร้างพื้นฐานและเครื่องมือ DevOps ครบถ้วนตามข้อกำหนด ดังนี้:
...
- **Database:** ใช้ PostgreSQL 14 Alpine พร้อม Mount Volume `db/init.sql` เพื่อ Initial ข้อมูลตั้งต้น

### 8.2 การสั่งรันระบบ
```bash
# บิลด์และสั่งทำงานระบบทั้งหมด
